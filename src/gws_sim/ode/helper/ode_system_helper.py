...
class ODESystemHelper(BaseSimSystemHelper):
    ...
    def simulate(
        ...
        * Return np.ndarray if `ODEINT` is used as method
        """
        if t_end <= t_start:
        ...
        if method == "ODEINT":
            ...
            return ODESolution(t_eval, solution, True, "")
        else:
            solution = solve_ivp(
            ...
            return ODESolution(solution.t, solution.y.T, solution.success, solution.message)
