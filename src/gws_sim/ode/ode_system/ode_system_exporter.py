...
@exporter_decorator(unique_name="ODESystemExporter", human_name="ODE system exporter",
                    source_type=ODESystem, target_type=File)
class ODESystemExporter(ResourceExporter):
    ...
    def export_to_path(
            self, source: ODESystem, dest_dir: str, params: ConfigParams, target_type: Type[File]) -> File:
        """
